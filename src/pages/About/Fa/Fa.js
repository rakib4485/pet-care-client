...
const Fa = () => {
    return (
        <div className='mx-[8%] grid lg:grid-cols-2 gap-10 items-center mt-28'>
            <div>
                <h2 className="text-primary text-2xl font-bold">{'//'} <span className='mx-3'>Faq</span> {'//'}</h2>
                <h2 className="text-4xl md:text-6xl font-bold text-secondary">Get Every Answer</h2>
                <h2 className=" text-4xl md:text-6xl font-bold text-secondary">From Here</h2>
                <div className='mt-10'>
            ...
            <div className='relative hidden md:block mt-32 lg:mt-0'>
