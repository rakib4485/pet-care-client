    ...
    return (
        <div className='max-w-screen overflow-hidden'>
            <div className='relative '>
                <svg id="e9lt8i6jeie71" viewBox="0 0 1371 915" shapeRendering="geometricPrecision" textRendering="geometricPrecision" className='hidden lg:block'>
                    <g id="e9lt8i6jeie72">
                        <g id="e9lt8i6jeie73">
                ...
                <div className='lg:absolute top-10'>
                    <div className='text-center md:w-[60%] mx-auto'>
                        <h1 className="text-4xl md:text-6xl font-bold text-secondary ">This is the only place for all your pet care</h1>
