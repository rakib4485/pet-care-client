...
const AppointmentButton = ({baseColor, HoverColor, buttonText}) => {
    return (
        <div>
            <a href="#_" class={`relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-mono font-medium tracking-tighter text-white ${baseColor} rounded-lg group`}>
